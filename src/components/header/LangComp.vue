<template>
  <div class="lang relative py-3 group cursor-pointer">
    <span class="flex gap-1">
      <svg class="w-6 h-6 duration-200 fill-[#f4f4f9] group-hover:fill-primary group-active:fill-primary"
...
<!--      <li v-for="(val, i) in activeArr" @click="langFunc(i)" :key="i"-->
<!--        class="flex gap-2 cursor-pointer hover:bg-gray-100 py-2 px-3">-->
...
const currentLangName = ref(localStorage.getItem("langName")) || 'Ru';
// console.log(currentLangName.value);
