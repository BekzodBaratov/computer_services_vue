<template>
  <div class="container mx-auto mt-4 flex justify-between items-center w-4/5 mb-6">
    ...
    <div class="flex items-end gap-4 h-full">
      <div @click="savedFunc" class="shopcart flex flex-col items-center cursor-pointer">
      ...
      <Teleport to="body">
        <div v-if="open" class="modal z-[999999] fixed inset-0 bg-[#0005] backdrop-blur-sm">
          <div
            class="absolute w-[30rem] inset-y-0 right-0 bg-blue-500 text-center flex flex-col justify-between items-center"
          >
            ...
            <div class="menu w-full bg-white text-[#4F87D3] rounded-t-xl px-8 py-8 space-y-6 h-[1/3]">
              <div class="flex justify-between items-center gap-3">
                <ButtonStrokeVue class="py-2">Введите промокод</ButtonStrokeVue>
                <ButtonStrokeVue class="py-2">Применить</ButtonStrokeVue>
              </div>
              <div class="space-y-1">
                <div class="flex justify-between items-center">
                  <p>Товар (2)</p>
              ...
              <div class="flex justify-between items-center">
                <ButtonFillVue to="/basket" class="py-2">Оформить заказ</ButtonFillVue>
