<template>
  ...
  >
    ...
    <div class="flex items-end gap-4 h-full">
      <RouterLink
        to="/favorites"
        @click="savedFunc"
        class="shopcart flex flex-col items-center cursor-pointer"
      >
  ...
  <Teleport class="basket" to="body">
    <div
      @click="open = false"
      v-if="open"
      class="modal fixed z-[999999] inset-0 bg-[#0005] backdrop-blur-sm"
    ></div>
    <div
    ...
    >
      ...
      >
        <div class="hidden flex justify-between items-center gap-3">
          <ButtonStrokeVue
            ><span class="py-2">Введите промокод</span></ButtonStrokeVue
          >
