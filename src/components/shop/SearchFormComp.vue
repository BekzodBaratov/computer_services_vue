          ...
          <div class="empty_img self-center">
            <svg width="12rem" height="10rem" viewBox="0 0 256 222" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                fill="#AE8350"
              />
              <path d="M215.914 78.2764L113.984 57.9018L128.275 0L233.124 20.9622L215.914 78.2764Z" fill="#DBC09E" />
              <path d="M165.613 221.221L215.915 182.746V78.2764L165.613 110.459V221.221Z" fill="#B89572" />
              <g style="mix-blend-mode: multiply" opacity="0.5">
                <path d="M113.984 57.9014V172.871L44.2363 190.649V86.1794L113.984 57.9014Z" fill="#AE8350" />
              </g>
              <path
              ...
              <path d="M165.612 221.221L44.2363 190.649V86.1797L165.612 110.459V221.221Z" fill="#C6A37D" />
              <path d="M118.476 154.714L0 127.971L44.2366 86.1797L165.612 110.459L118.476 154.714Z" fill="#DBC09E" />
              <g style="mix-blend-mode: soft-light">
                <path d="M164.21 111.766L43.0801 87.26L44.2362 86.1797L165.612 110.459L164.21 111.766Z" fill="white" />
              </g>
              <path d="M156.988 176.359L141.75 172.72V170.806L156.988 174.445V176.359Z" fill="#4E2B07" />
              <path d="M156.988 177.667L141.75 174.028V173.308L156.988 176.947V177.667Z" fill="#4E2B07" />
              <path d="M156.988 179.221L141.75 175.601V174.881L156.988 178.52V179.221Z" fill="#4E2B07" />
              <path d="M156.988 180.851L141.75 177.231V176.511L156.988 180.15V180.851Z" fill="#4E2B07" />
              <path d="M156.988 182.614L141.75 178.975V178.273L156.988 181.893V182.614Z" fill="#4E2B07" />
              <path d="M156.988 184.244L141.75 180.605V179.903L156.988 183.523V184.244Z" fill="#4E2B07" />
              <path d="M156.988 187.447L141.75 183.808V182.178L156.988 185.817V187.447Z" fill="#4E2B07" />
              <path d="M156.988 191.654L141.75 188.034V187.313L156.988 190.952V191.654Z" fill="#4E2B07" />
              <path d="M156.988 189.778L141.75 186.158V185.438L156.988 189.077V189.778Z" fill="#4E2B07" />
              <path d="M156.988 193.227L141.75 189.588V188.887L156.988 192.507V193.227Z" fill="#4E2B07" />
              <path d="M156.988 194.857L141.75 191.218V190.517L156.988 194.137V194.857Z" fill="#4E2B07" />
              <path d="M156.988 196.62L141.75 192.981V192.261L156.988 195.9V196.62Z" fill="#4E2B07" />
              <path d="M156.988 198.25L141.75 194.611V193.891L156.988 197.53V198.25Z" fill="#4E2B07" />
              <path d="M156.988 200.372L141.75 196.752V195.104L156.988 198.743V200.372Z" fill="#4E2B07" />
              <path d="M156.988 202.76L141.75 199.121V197.491L156.988 201.13V202.76Z" fill="#4E2B07" />
              <path d="M156.988 206.02L141.75 202.381V200.221L156.988 203.86V206.02Z" fill="#4E2B07" />
              <g opacity="0.2">
                <path
...
<!--            <pre>{{store}}</pre>-->
          ...
          >
            <div class="img h-full">
              <img class="object-cover h-full w-full object-center" :src="item?.image_url" alt="cardImg" />
            </div>
            <div class="img rounded-xl bg-[#F4F6F9] flex flex-col gap-3 p-3 relative">
                <div class="delete absolute top-2 right-3 cursor-pointer" @click="deleteProduct(item.id)">
...
<!--                </div>-->
      ...
      <div class="menu w-full bg-white text-primaryBlue rounded-t-xl px-8 py-8 space-y-6 h-[1/3]">
        ...
        <div class="flex justify-between items-center">
          <ButtonFillVue to="/basket"><span class="py-2">Оформить заказ</span></ButtonFillVue>
          <button @click="open = false" class="underline p-2 hover:no-underline">Закрыть</button>
        </div>
      </div>
    </div>
  </Teleport>
