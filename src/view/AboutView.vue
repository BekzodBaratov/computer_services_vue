...
const faqData = ref([
    {
        answer:'Добавьте понравившийся товар в корзину, напишите свое имя, фамилию и номер телефона и нажмите кнопку купить Мы свяжемся с вами!',
        question:"Как купить товары, представленные на сайте?"
    }, {
        answer:'Для этого перейдите в раздел Конфигурация нашего сайта и выберите подходящее вам оборудование из категорий.',
        question:"Как мне отсортировать необходимое мне компьютерное оборудование?"
    },
    {
        answer:'Для этого вы должны сначала зарегистрироваться на нашем сайте, затем вы можете перейти в раздел продукта и оставить свои комментарии в разделе комментариев.',
        question:"Как я могу написать отзыв о товарах?"
    }, {
        answer:'Для этого зайдите в сервисный раздел нашего сайта и выберите подходящий Вам вид услуги, нажмите кнопку вызова!',
