<template>
  ...
  <div class="container mx-auto">
    ...
    <h1 class="text-2xl mb-3 text-[#002E69]">{{ singleObj.name }}</h1>
    <div class="flex items-center">
      ...
      <p class="ml-2 font-bold text-[#4F87D3]">4.95</p>
      <span class="w-1 h-1 mx-3 bg-[#769acd] rounded-full"></span>
      <a href="#" class="font-medium text-[#4F87D3] underline hover:no-underline">50 отзывов</a>
    </div>
    ...
    <div class="moreInfo">
      <div class="flex gap-4 mb-6">
        <button
          ...
          :class="infomations === 0 ? 'text-[#002E69] border-[#002E69]' : 'text-[#4F87D3CC] border-[#4F87D3CC]'"
        >
          Описание
        </button>
        <button
          @click="infomations = 1"
          class="font-bold border-b py-1"
          :class="infomations === 1 ? 'text-[#002E69] border-[#002E69]' : 'text-[#4F87D3CC] border-[#4F87D3CC]'"
        >
          Обзоры
        </button>
        <button
          @click="infomations = 2"
          class="font-bold border-b py-1"
          :class="infomations === 2 ? 'text-[#002E69] border-[#002E69]' : 'text-[#4F87D3CC] border-[#4F87D3CC]'"
        >
          Отзывы
        </button>
      </div>
    ...
    <div class="my-10">
      <h3 class="text-3xl text-[#002E69] pb-4">Похожие товары</h3>
      <SmilarsCompVue />
    </div>
  </div>
</template>
